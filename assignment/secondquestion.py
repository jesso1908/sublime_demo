...
[14458.95,14586.3,14670.5,14765.45,14625.9],[14287.5,14570,14645.15,14598.6,14380.15],[13.2,11,8.85,9.92,16.4]]
...
"""price range"""
price_range=[]
zip_object=zip(last_Week_data[2],last_Week_data[1])
for i,j in zip_object:
	price_range.append(i-j)
print(price_range)
sorted_volume=sorted(last_Week_data[4])
print("the sorted volume list:",sorted_volume)
