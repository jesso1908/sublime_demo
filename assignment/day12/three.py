...
high_prices=[14458.95,14586.3,14670.5,14765.45,14625.9]
...
c=is_bullishharami(open_prices,high_prices,low_prices,close_prices)
print(c)
...
d=is_bearishharami(open_prices,high_prices,low_prices,close_prices)
print(d)
...
e=is_darkcloud(open_prices,high_prices,low_prices,close_prices,mid_point)
print(e)
...
f=is_risingsun(open_prices,high_prices,low_prices,close_prices,mid_point)
print(f)